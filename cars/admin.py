...
class CarAdmin(admin.ModelAdmin):
    ...
    list_display = ( 'id','serie_Sasiu','thumbnail', 'car_title', 'judet', 'culoare', 'model','an','caroserie','tip_combustibil','is_featured')
    list_display_links = ( 'id','serie_Sasiu','thumbnail','car_title')
